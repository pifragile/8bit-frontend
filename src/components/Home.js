    ...
    return (
        <Layout>
            ...
            1byte is a generative audio project by {" "}
                ...
                All sounds are created using Tone.js and melodies are algorithmically generated. See code snippets below.

            <button style={{width: "min(400px, 80vw)", marginTop: "5vh"}} onClick={handleMint}>Mint for {formatMutez(tokenPrice)}</button>
            </div>
            ...
            <div style={{ marginTop: "5vh" }}>
                <h1>All tokens</h1>
                Click the token to open the detail view where you can play the sound.
                <TokenOverview
